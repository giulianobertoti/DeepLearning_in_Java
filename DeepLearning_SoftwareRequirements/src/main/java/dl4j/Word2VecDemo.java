...
public class Word2VecDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Collection<String> crianca = word2VecModel.wordsNearest("criança" , 10);
        System.out.println("criança: " + crianca);

        Collection<String> alcool = word2VecModel.wordsNearest("álcool", 10);
        System.out.println(" álcool: " + alcool);
        
        Collection<String> oficina = word2VecModel.wordsNearest("oficina", 10);
